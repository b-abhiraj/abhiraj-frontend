...
const Homepage = () => {
  ...
  return (
    <Layout>
      <div className="dark:bg-gray-900 pt-40 lg:p-20">
        ...
        <main className="flex-1 p-4 lg:p-10 ">
          <div className="">
            <section id="features" className="mb-8 lg:space-y-8">
              <h2 className="sm:text-lg lg:text-8xl md:text-5xl font-Kanit md:font-extrabold pb-6 text-center dark:text-white lg:py-20  ">
                Unleash the Power of the Cloud!
              </h2>
              <div className=" text-center">
                <button
                  onClick={() => navigate("/register")}
                  className="text-center dark:bg-gray-800 p-4 px-8 rounded-xl hover:bg-[#1949d2] hover:border-gray-400 hover:border-4 hover:border-spacing-5 border-4 border-[#1949d2]  dark:text-white"
                >
                  Get Started
                </button>
              </div>
              <p className="font-Roboto dark:text-white text-lg  text-center pt-5">
                Explore the powerful features of our cloud hosting platform,
                including high-speed servers , easy scalability, and robust
                security measures.
              </p>
              <p className="mt-2 text-lg dark:text-white font-Roboto text-center pt-5">
          ...
          <section id="pricing" className="mb-8 pt-16">
            <div className="border border-rose-500 shadow-rose-500 shadow-lg">
              <h2 className="text-3xl mb-2 dark:text-white font-Roboto_mono text-center p-10">
                Choose Your Perfect Plan
              </h2>
              <div className="flex flex-wrap justify-around mt-4">
                <div className="bg-white dark:text-gray-300 dark:bg-primary p-6 rounded-lg shadow-lg w-80 text-center mb-4">
                  ...
                  <button className="bg-indigo-500 text-white py-2 px-4 dark:text-gray-300  rounded hover:bg-indigo-600">
                    $0 /month
                  </button>
                ...
                <div className="bg-white p-6 dark:text-gray-300 dark:bg-primary rounded-lg shadow-lg w-80 text-center mb-4">
